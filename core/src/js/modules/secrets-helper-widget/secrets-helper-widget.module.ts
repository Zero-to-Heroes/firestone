...
import { SecretsHelperWidgetComponent } from '../../components/secrets-helper-widget/secrets-helper-widget.component';
...
@NgModule({
	...
	declarations: [SecretsHelperWidgetComponent],
	bootstrap: [SecretsHelperWidgetComponent],
	providers: [DebugService, Events, GenericIndexedDbService, PreferencesService, OverwolfService],
})
export class SecretsHelperWidgetModule {}
