...
const windowName = OverwolfService.COUNTER_PLAYER_CTHUN_WINDOW;

export class CthunPlayerCounterOverlayHandler implements OverlayHandler {
	...
	public async handleDisplayPreferences(preferences: Preferences) {
		this.showCounter = preferences.playerCthunCounter;
	}
