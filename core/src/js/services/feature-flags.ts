export class FeatureFlags {
	...
	public static readonly SHOW_CONSTRUCTED_SECONDARY_WINDOW = true; // Doesn't work anymore?
	public static readonly ENABLE_RANKED_ARCHETYPE = true; // Doesn't work anymore?
