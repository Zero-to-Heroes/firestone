				...
				updates: [
					...
					},
					{
						...
						details: [
							...
							{
								type: 'feature',
								text: `Mousing over Swordfish in the tracker now highlights pirates in the deck.`,
							},
							{
								type: 'feature',
								text: `Mousing over Gorgloc Ravager in the tracker now highlights murlocs in the deck.`,
							},
							{
								type: 'bug',
							...
							{
								type: 'bug',
								text: `Add decklist support for Brawliseum.`,
							},
						],
					},
					{
