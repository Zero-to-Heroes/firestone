...
{
    public class MercenariesHeroRevived : ActionParser
    {
        private GameState GameState { get; set; }
        private ParserState ParserState { get; set; }
        private StateFacade StateFacade { get; set; }

        public MercenariesHeroRevived(ParserState ParserState, StateFacade facade)
        {
        ...
        public List<GameEventProvider> CreateGameEventProviderFromClose(Node node)
        {
            ...
            //var gameState = GameEvent.BuildGameState(ParserState, StateFacade, GameState);
