...
export class KrippAmazingPlaysSetProvider extends SetProvider {
    ...
    constructor(cardsService: AllCardsService, conf: AchievementConfService) {
        super('kripp_achievements_1_amazing_plays', 'Amazing Plays', [
            'kripp_achievements_1_one_hp_remaining',
            'kripp_achievements_1_mass_hysteria',
        ]);
        this.logoName = 'kripp_achievements_1_amazing_plays';
