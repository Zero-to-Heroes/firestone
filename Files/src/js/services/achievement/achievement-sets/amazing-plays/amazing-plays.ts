...
export class AmazingPlaysSetProvider extends SetProvider {
	private logoName: string;
	private conf: AchievementConfService;

	constructor(conf: AchievementConfService) {
		super('amazing_plays', 'Amazing Plays', ['amazing_play_win_with_one_hp']);
		this.logoName = 'achievements_amazing_plays';
		this.conf = conf;
	}
