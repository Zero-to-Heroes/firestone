...
export class OverwolfService {
    ...
    public static COLLECTION_WINDOW: string = 'CollectionWindow';
    public static SETTINGS_WINDOW: string = 'SettingsWindow';
    public static LOADING_WINDOW: string = 'LoadingWindow';
    public static WELCOME_WINDOW: string = 'WelcomeWindow';
    public static DECKTRACKER_WINDOW: string = 'DeckTrackerWindow';
    public static NOTIFICATIONS_WINDOW: string = 'NotificationsWindow';
