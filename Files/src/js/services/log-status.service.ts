...
export class LogStatusService {
	...
	private createAppRunningToast(monitoredObject: string) {
		...
		this.loaded = true;
		this.notificationService.html(`<div class="message-container"><img src="/IconStore.png"><div class="message">Lorekeeper is now monitoring your ${monitoredObject} file.</div></div>`);
	}
