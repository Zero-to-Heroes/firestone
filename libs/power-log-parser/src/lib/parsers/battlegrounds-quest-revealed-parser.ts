...
export class BattlegroundsQuestRevealedParser implements ActionParser {
	readonly ParserName = 'BattlegroundsQuestRevealedParser';
			...
			GameEventProvider.Create(
				...
				GameEventHelper.CreateProvider(
					...
					this.StateFacade,
					{
						...
						IsHeroPowerReward:
							tagChange.Name === (GameTag.BACON_HERO_HEROPOWER_QUEST_REWARD_DATABASE_ID as number),
					},
				),
				true,
				node,
