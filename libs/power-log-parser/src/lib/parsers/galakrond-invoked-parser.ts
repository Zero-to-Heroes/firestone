...
export class GalakrondInvokedParser implements ActionParser {
	readonly ParserName = 'GalakrondInvokedParser';
	...
	AppliesOnNewNode(node: Node, stateType: StateType): boolean {
		return (
			...
			(node.Object as TagChange).Name === (GameTag.INVOKE_COUNTER as number)
		);
	}
