...
export const isDefault = (maxResources: MaxResources): boolean =>
	...
	(maxResources.corpses === 0 || maxResources.corpses == null);
...
export const nullIfDefaultCorpses = (corpses: number): number => (corpses === 0 || corpses == null ? null : corpses);
