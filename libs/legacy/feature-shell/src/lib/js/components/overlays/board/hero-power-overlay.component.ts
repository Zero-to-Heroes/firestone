...
import { CardsHighlightFacadeService, DeckCard, VisualDeckCard } from '@firestone/game-state';
...
export class HeroPowerOverlayComponent implements AfterViewInit {
	...
	onMouseEnter(event: MouseEvent) {
		this.cardsHighlightService?.onMouseEnter(this._referenceCard?.id, this._card?.entityId, this.side, this._card);
	}
