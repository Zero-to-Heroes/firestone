...
export class ConstructedTimeFilterDropdownComponent extends AbstractSubscriptionComponent implements AfterContentInit {
	...
	onSelected(option: IOption) {
		this.prefs.updatePrefs('constructedMetaDecksTimeFilter', (option as FilterOption).value);
	}
}
