	...
	implements AfterContentInit
{
	...
	async ngAfterContentInit() {
		...
		this.filter$ = this.prefs.preferences$$.pipe(this.mapData((prefs) => prefs.collectionCardOwnedFilter)).pipe(
	...
	onSelected(option: IOption) {
		this.prefs.updatePrefs('collectionCardOwnedFilter', option.value as CollectionCardOwnedFilterType);
	}
}
