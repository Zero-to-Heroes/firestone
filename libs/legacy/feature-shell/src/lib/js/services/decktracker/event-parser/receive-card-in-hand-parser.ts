...
export class ReceiveCardInHandParser implements EventParser {
	...
	async parse(currentState: GameState, gameEvent: GameEvent): Promise<GameState> {
		...
		// Check to see if the card is generated by Mindrender Illucia.
		const isCreatedByMindrenderIllucia = gameEvent.additionalData.creatorCardId === CardIds.MindrenderIllucia;
		// console.debug(
