...
// 	questStats: readonly BgsQuestStats['questStats'][0][],
...
// 		.filter((stat) => stat.timePeriod === timeFilter)
// 		// Backward compatilibity
// 		.filter((stat) => stat.mmrPercentile === cleanRankFilter);
// 	const groupedByHero = groupByFunction((stat: BgsGlobalQuestStat) => stat.cardId)(filteredGlobalStats);
