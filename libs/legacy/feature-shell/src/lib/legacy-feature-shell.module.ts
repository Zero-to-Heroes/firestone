...
@NgModule({
	...
	providers: [
		...
		{ provide: EXTERNAL_URL_SERVICE_TOKEN, useExisting: OverwolfService },
		{ provide: CLIPBOARD_SERVICE_TOKEN, useExisting: OverwolfService },
		{ provide: FILE_SYSTEM_UI_SERVICE_TOKEN, useExisting: OverwolfService },
		{ provide: MONITORS_SERVICE_TOKEN, useExisting: OverwolfService },
		{ provide: SYSTEM_INFO_SERVICE_TOKEN, useExisting: OverwolfService },
