...
export class Preferences implements IPreferences {
	...
	@Reflect.metadata(FORCE_LOCAL_PROP, true)
	readonly helpTooltipScale: number = 100;
	readonly notificationsScale: number = 100;
	@Reflect.metadata(FORCE_LOCAL_PROP, true)
	...
	readonly seenSpotlightIds: readonly string[] = [];
	...
	readonly decktrackerMinionPlayOrderScale: number = 100;
	...
	readonly decktrackerMulliganLinger: 'off' | '5' | '10' | 'until-dismissed' = 'off';
	@Reflect.metadata(FORCE_LOCAL_PROP, true)
	...
	readonly arenaClassStatsMatrixEnabled: boolean = false;
	...
	readonly playerPiratesSummonedCounter: boolean = true;
	readonly opponentPiratesSummonedCounter: boolean = true;
	...
	readonly playerCardsPlayedFromAnotherClassCounter: boolean = true;
	readonly opponentCardsPlayedFromAnotherClassCounter: boolean = true;
	...
	readonly opponentYsondreCounter: boolean = true;
	readonly playerImbueCounter: boolean = true;
	readonly opponentImbueCounter: boolean = true;
	readonly playerBashanaCounter: boolean = true;
	readonly opponentBashanaCounter: boolean = true;
	readonly playerHeraldCounter: boolean = true;
	readonly opponentHeraldCounter: boolean = true;
	...
	readonly playerDeathwingReductionCounter: boolean = true;
	readonly opponentDeathwingReductionCounter: boolean = true;
	...
	readonly playerCorpsesCounter: boolean = true;
	...
	readonly playerMaxResourcesWidgetPositionBgs: { left: number; top: number };
	...
	readonly opponentMaxResourcesWidgetPositionBgs: { left: number; top: number };
	readonly opponentMaxResourcesWidgetAlwaysOn: boolean = false;
	readonly playerMaxResourcesWidgetShowCorpses: boolean = false;
	readonly opponentMaxResourcesWidgetShowCorpses: boolean = false;
	...
	readonly playerKiljaedenCounter: boolean = true;
	readonly opponentKiljaedenCounter: boolean = true;
	readonly playerElizaGorebladeCounter: boolean = true;
	readonly opponentElizaGorebladeCounter: boolean = true;
	...
	readonly playerKaelthasSpellCycleCounter: boolean = true;
	readonly opponentStarshipsLaunchedCounter: boolean = true;
	readonly playerRenferalTheMalignantCounter: boolean = true;
	readonly opponentRenferalTheMalignantCounter: boolean = true;
	readonly playerDarkGiftsCounter: boolean = true;
	readonly opponentDarkGiftsCounter: boolean = true;
	readonly playerOutcastCounter: boolean = true;
	readonly playerSecretsTriggeredCounter: boolean = true;
	readonly playerShirvallahCounter: boolean = true;
	readonly playerOverloadCardsPlayedCounter: boolean = true;
	readonly opponentOverloadCardsPlayedCounter: boolean = true;
	readonly playerFreebirdCounter: boolean = true;
	readonly playerFrostSpellsCounter: boolean = true;
	readonly playerFriendlyDeadMinionsThisTurnCounter: boolean = true;
	readonly playerDamageTakenThisTurnCounter: boolean = true;
	readonly playerDamageToOpponentThisTurnCounter: boolean = true;
	readonly playerHeroDamageInstancesThisTurnCounter: boolean = true;
	readonly playerNonClassCardsAddedToHandCounter: boolean = true;
	readonly playerTotemsSummonedCounter: boolean = true;
	readonly playerBeastsSummonedCounter: boolean = true;
	readonly playerWeaponsEquippedCounter: boolean = true;
	readonly playerFelSpellCounter: boolean = true;
	readonly playerCardsDiscardedCounter: boolean = true;
	...
	readonly playerBgsWhelpBuffCounter: boolean = true;
	...
	readonly bgsHideBattleOddsUntilMouseOver = false;
	...
	readonly bgsEnableDarkGiftOverlay: boolean = true;
	@Reflect.metadata(FORCE_LOCAL_PROP, true)
