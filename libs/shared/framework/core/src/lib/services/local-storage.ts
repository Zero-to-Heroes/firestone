...
export class LocalStorageService {
	...
	public static LOCAL_STORAGE_ARENA_MULLIGAN_ADVICE_SEEN = 'LOCAL_STORAGE_ARENA_MULLIGAN_ADVICE_SEEN';
	public static LOCAL_STORAGE_ARENA_DISCOVER_STATS_SEEN = 'LOCAL_STORAGE_ARENA_DISCOVER_STATS_SEEN';
	public static LOCAL_STORAGE_CONSTRUCTED_DISCOVER_STATS_SEEN = 'LOCAL_STORAGE_CONSTRUCTED_DISCOVER_STATS_SEEN';
	public static LOCAL_STORAGE_BGS_IN_GAME_QUESTS_STATS_SEEN = 'LOCAL_STORAGE_BGS_IN_GAME_QUESTS_STATS_SEEN';
	public static LOCAL_STORAGE_BGS_INTERMEDIATE_RESULTS_GAMES_USED =
		'LOCAL_STORAGE_BGS_INTERMEDIATE_RESULTS_GAMES_USED';
	public static LOCAL_STORAGE_BGS_IN_GAME_TRINKETS_STATS_SEEN = 'LOCAL_STORAGE_BGS_IN_GAME_TRINKETS_STATS_SEEN';
	public static LOCAL_STORAGE_BGS_IN_GAME_TIMEWARPED_STATS_SEEN = 'LOCAL_STORAGE_BGS_IN_GAME_TIMEWARPED_STATS_SEEN';
