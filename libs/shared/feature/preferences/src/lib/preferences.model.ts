...
} from '@core/src/js/models/collection/filter-types';
...
import { AchievementsCompletedFilterType } from '@core/src/js/models/mainwindow/achievement/filter-types';
...
import { StatGameFormatType } from '@core/src/js/models/mainwindow/stats/stat-game-format.type';
