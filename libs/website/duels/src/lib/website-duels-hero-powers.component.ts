...
import { getAllMetaHeroPowerStats } from './+state/website/duels.selectors';

@Component({
	selector: 'website-duels-hero-powers',
	styleUrls: ['./meta-info.scss', `./website-duels-hero-powers.component.scss`],
	template: `
...
export class WebsiteDuelsHeroPowersComponent implements AfterContentInit {
