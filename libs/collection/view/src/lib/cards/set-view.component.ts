...
export class SetViewComponent {
	...
	@Input() set setId(value: string) {
		this._setId = value;
		this.logoUrl = `https://static.zerotoheroes.com/hearthstone/asset/firestone/images/sets/${value}.png?v=2`;
		this.setName = `global.set.${value}`;
		if (['classic', 'core', 'legacy', 'demon_hunter_initiate', 'caverns_of_time', 'gift'].includes(value)) {
