...
export const GOLDEN_SET_PACKS = [
	...
	BoosterType.GOLDEN_ACROSS_THE_TIMEWAYS,
	BoosterType.GOLDEN_CATACLYSM,
];
...
export const CATCH_UP_PACK_IDS = [
	...
	BoosterType.ACROSS_THE_TIMEWAYS_CATCH_UP,
	BoosterType.CATACLYSM_CATCH_UP,
	BoosterType.ESCAPE_FROM_VIOLET_HOLD_CATCH_UP,
];
