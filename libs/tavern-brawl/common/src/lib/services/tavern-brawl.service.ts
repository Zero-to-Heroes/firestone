...
import { ExtendedDeckStat, ExtendedDeckStats } from '../models/tavern-brawl.models';
...
export class TavernBrawlService extends AbstractFacadeService<TavernBrawlService> {
	...
	protected override initElectronSubjects(): void {
		this.setupElectronSubject(this.tavernBrawl$$, 'TavernBrawlService-tavernBrawl');
		this.setupElectronSubject(this.metaDecks$$, 'TavernBrawlService-metaDecks');
		this.setupElectronSubject(this.cardSearch$$, 'TavernBrawlService-cardSearch');
	}
