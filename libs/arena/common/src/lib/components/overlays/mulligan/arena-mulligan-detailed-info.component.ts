...
@Component({
	selector: 'arena-mulligan-detailed-info',
	styleUrls: [`./arena-mulligan-detailed-info.component.scss`],
	template: `
...
export class ArenaMulliganDetailedInfoComponent extends AbstractSubscriptionComponent implements AfterContentInit {
	...
	ngAfterContentInit() {
		...
		this.footerText$ = this.chartData$$.pipe(
			this.mapData((data) => {
				return data
					? this.i18n.translateString('arena.overlay.mulligan.mulligan-overview-footer', {
