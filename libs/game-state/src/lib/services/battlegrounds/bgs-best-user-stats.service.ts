...
export class BgsBestUserStatsService extends AbstractFacadeService<BgsBestUserStatsService> {
	public bestStats$$: SubscriberAwareBehaviorSubject<readonly BgsBestStat[] | null>;
	...
	constructor(protected override readonly windowManager: WindowManagerService) {
		super(windowManager, 'BgsBestUserStatsService', () => !!this.bestStats$$);
	}
	...
	protected async init() {
		...
		this.bestStats$$.onFirstSubscribe(async () => {
			...
			const remoteData: readonly BgsBestStat[] | null = await this.api.callGetApi(
