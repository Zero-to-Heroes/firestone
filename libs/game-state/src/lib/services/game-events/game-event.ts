...
export class GameEvent implements GameStateEvent {
	...
	public static readonly POWER_TRIGGERED_END = 'POWER_TRIGGERED_END';
	...
	public static readonly SPECIAL_TARGET = 'SPECIAL_TARGET';
	...
	public static readonly TIMEWARPED_TAVERN_STARTED = 'TIMEWARPED_TAVERN_STARTED';
	public static readonly TIMEWARPED_TAVERN_ENDED = 'TIMEWARPED_TAVERN_ENDED';
