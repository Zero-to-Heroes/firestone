...
import { TimewarpTavernEndedParser } from './event-parser/battlegrounds/timewarp-tavern-ended-parser';
import { TimewarpTavernStartedParser } from './event-parser/battlegrounds/timewarp-tavern-started-parser';
...
export class GameStateParsersService {
	...
	public buildEventParsers(): { [eventKey: string]: readonly EventParser[] } {
		...
		const parsers: { [eventKey: string]: EventParser[] } = {
			...
			[GameEvent.TIMEWARPED_TAVERN_STARTED]: [new TimewarpTavernStartedParser()],
