...
export const buildEntityFromBoardEntity = (minion: BoardEntity, allCards: CardsFacadeService): Entity => {
	return Entity.create({
		...
		tags: {
			...
			[GameTag[GameTag.TAG_SCRIPT_DATA_NUM_3]]: minion.scriptDataNum3,
			[GameTag[GameTag.TAG_SCRIPT_DATA_NUM_4]]: minion.scriptDataNum4,
			[GameTag[GameTag.TAG_SCRIPT_DATA_NUM_5]]: minion.scriptDataNum5,
			[GameTag[GameTag.TAG_SCRIPT_DATA_NUM_6]]: minion.scriptDataNum6,
