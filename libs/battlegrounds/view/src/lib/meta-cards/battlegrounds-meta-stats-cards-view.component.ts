...
@Component({
	standalone: false,
	selector: 'battlegrounds-meta-stats-cards-view',
	styleUrls: [
		`./battlegrounds-meta-stats-cards-columns.scss`,
		`./battlegrounds-meta-stats-cards-view.component.scss`,
	],
	template: `
...
export class BattlegroundsMetaStatsCardsViewComponent
	...
	implements AfterContentInit
{
	...
	@Input() set stats(value: readonly BgsMetaCardStatTierItem[] | null) {
		this.stats$$.next(value);
	}
	@Input() set totalGames(value: number | null) {
	...
	private totalGames$$ = new BehaviorSubject<number | null>(null);
