	...
	return [
		{
			...
			items: filterQuestRewardItems(questStats, 0, mean - 3 * standardDeviation),
		},
		{
			...
			items: filterQuestRewardItems(questStats, mean - 3 * standardDeviation, mean - 1.5 * standardDeviation),
		},
		{
			...
			items: filterQuestRewardItems(questStats, mean - 1.5 * standardDeviation, mean),
		},
		{
			...
			items: filterQuestRewardItems(questStats, mean, mean + standardDeviation),
		},
		{
			...
			items: filterQuestRewardItems(questStats, mean + standardDeviation, mean + 2 * standardDeviation),
		},
		{
			...
			items: filterQuestRewardItems(questStats, mean + 2 * standardDeviation, null),
		},
